...
- Relay WebSocket adapter：`financeex.agent-runtime.relay.websocket.url`、`app-mode`、`connection-mode`、`connect-timeout`、`config-handshake-timeout`、`idle-timeout`、`max-frame-bytes`、`idle-ttl`、`max-cached-connections`
