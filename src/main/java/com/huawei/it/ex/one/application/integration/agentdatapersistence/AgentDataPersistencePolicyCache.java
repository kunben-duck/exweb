...
public interface AgentDataPersistencePolicyCache {
    Optional<AgentDataPersistencePolicy> get(String runtimeProvider, String skillId);

    void put(String runtimeProvider, String skillId, AgentDataPersistencePolicy policy, Duration ttl);
}
