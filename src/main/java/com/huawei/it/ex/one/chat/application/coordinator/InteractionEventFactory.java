...
/** Builds the existing Interaction and route progress event payloads. */
@Component
public class InteractionEventFactory {
    public Flux<ChatEvent> intentClarificationWaitingBody(String runId, String sessionId,
    ...
    public RuntimeEvent intentClarificationRequestEvent(String runId, String sessionId,
                                                        Map<String, Object> requestPayload) {
    ...
    public RuntimeEvent routeProgressEvent(String runId, String sessionId, RouteSignalProgress progress) {
    ...
    public RuntimeEvent clarificationResponseEvent(String runId, String sessionId,
    ...
    public RuntimeEvent routeSwitchResponseEvent(String runId, String sessionId,
                                                 ChatInteractionRequest interaction,
                                                 Map<String, Object> responsePayload) {
        Map<String, Object> payload = new LinkedHashMap<>();
        payload.put("source", "chatservice");
    ...
    public RuntimeEvent routeSwitchDeclinedEvent(String runId, String sessionId,
                                                 ChatInteractionRequest interaction) {
        Map<String, Object> payload = new LinkedHashMap<>();
        payload.put("source", "chatservice");
    ...
    public RuntimeEvent routeSwitchAppliedEvent(String runId, String sessionId,
                                                ChatInteractionRequest interaction,
                                                RouteTarget route,
