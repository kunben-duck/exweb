...
public class ChatInteractionApplicationService {
    ...
    public ChatInteractionClaimResult claimPreparedInteractionResponse(
    ...
    public Map<String, Object> prepareResponsePayload(ChatInteractionResponseCommand command,
    ...
    private void validateResponse(ChatInteractionResponseCommand command, ChatInteractionType interactionType,
        ...
        if (safeType == ChatInteractionType.INTENT_CLARIFICATION) {
            validateIntentClarificationResponse(command, intentAnswer);
        }
    }

    private void validateIntentClarificationResponse(ChatInteractionResponseCommand command, String intentAnswer) {
    ...
    public String optionalIntentClarificationAnswer(Map<String, Object> answers) {
