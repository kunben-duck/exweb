 ...
 * ROUTE_SINGLE 通常映射为 DomainAgent，配置的专家或敏感信息 accessName 映射为 AgentRuntime；
 * ROUTE_MULTI/NO_MATCH 映射为 AgentRuntime。</p>
 *
 ...
 * @param candidateDomainAgentId ROUTE_SINGLE 时归一化后的 item.accessName；最终目标由路由策略决定。
 * @param slots 已识别槽位。
