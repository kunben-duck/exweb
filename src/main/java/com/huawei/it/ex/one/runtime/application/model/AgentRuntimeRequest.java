...
public record AgentRuntimeRequest(
        ...
        RuntimeMemorySnapshot memoryContext,
        RuntimeIntentSnapshot intentDecision,
        RuntimeRouteSnapshot routeTarget,
    ...
    public AgentRuntimeRequest(String tenantId, String userId, String userAccount, Long globalUserId,
                               ...
                               List<RuntimeAttachmentSnapshot> attachments, List<RuntimeDocumentSnapshot> documents,
                               RuntimeMemorySnapshot memoryContext, RuntimeIntentSnapshot intentDecision,
                               RuntimeRouteSnapshot routeTarget,
    ...
    public AgentRuntimeRequest(String tenantId, String userId, String userAccount, Long globalUserId,
                               String sessionId, String runId, String runtimeSessionId,
                               RuntimeSessionMode runtimeSessionMode, String message,
                               List<RuntimeAttachmentSnapshot> attachments, RuntimeMemorySnapshot memoryContext,
                               RuntimeIntentSnapshot intentDecision, RuntimeRouteSnapshot routeTarget,
