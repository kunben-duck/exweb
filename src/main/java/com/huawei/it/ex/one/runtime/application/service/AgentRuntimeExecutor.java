 ...
 */
@Service
public class AgentRuntimeExecutor implements RuntimeExecutionService {
    ...
    public Flux<ChatEvent> execute(RuntimeExecutionContext context) {
        ...
        List<RuntimeAttachmentSnapshot> attachments = command.attachments() == null
                ? List.of()
                : command.attachments();
    ...
    public Mono<Void> cancel(RuntimeRunSnapshot run, UserContext user,
