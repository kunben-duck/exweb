...
public class ConfiguredDomainAgentClient implements DomainAgentClient {
    ...
    // Timer, upstream and downstream cancellation are one response-stream termination state machine. The callback
    // ordering is deliberately kept intact to preserve exactly-once terminal propagation.
