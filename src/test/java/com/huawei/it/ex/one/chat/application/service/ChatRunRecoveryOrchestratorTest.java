...
import com.huawei.it.ex.one.chat.application.recovery.FailFastRecoveryStrategy;
import com.huawei.it.ex.one.chat.application.recovery.ManualConfirmationRecoveryStrategy;
...
class ChatRunRecoveryOrchestratorTest {
    ...
    private ChatRunTerminalCommitService terminalCommitService(ChatStreamApplicationService streamService,
                                                                ...
                                                                ChatInteractionApplicationService interactionService) {
        return ChatTerminalTestFixture.service(streamService, null, runs, leaseService, null,
    ...
    private RuntimeRecoveryService unsupportedRuntimeRecovery() {
        return new RuntimeRecoveryService() {
