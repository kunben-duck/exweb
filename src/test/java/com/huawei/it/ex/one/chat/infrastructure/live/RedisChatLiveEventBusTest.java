        ...
        StepVerifier.create(bus.subscribe("chat-run-run1"))
                ...
                .expectErrorSatisfies(ex -> {
                    org.assertj.core.api.Assertions.assertThat(ex)
                            .isInstanceOf(com.huawei.it.ex.one.chat.application.model.ChatLiveRecoveryRequiredException.class);
                    var recovery = (com.huawei.it.ex.one.chat.application.model.ChatLiveRecoveryRequiredException) ex;
