...
class RuntimeBindingApplicationServiceTest {
    ...
    private RuntimeInteractionBindingRequest interactionRequest(String runtimeSessionId) {
        return new RuntimeInteractionBindingRequest(
                "interaction1", "t", "u", "s", "msg-assistant", "binding1", runtimeSessionId);
    }
